  ...
  return (
    ...
    >
      <div className="space-y-6">
        <div>
          <label className="block text-sm font-serif text-[var(--color-brand-plum)] mb-2 font-semibold">
            Your Name
          </label>
          <input
            {...register('name', { required: 'Name is required' })}
            className="w-full px-4 py-3 rounded-xl border border-blue-200 bg-white focus:outline-none focus:ring-2 focus:ring-[var(--color-brand-plum)]/50"
            placeholder="Name"
          />
        </div>
        <div>
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-4 py-3 rounded-xl border border-blue-200 bg-white focus:outline-none focus:ring-2 focus:ring-[var(--color-brand-plum)]/50 resize-none"
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="w-full py-4 bg-gradient-to-r from-[var(--color-brand-lavender)] to-[var(--color-brand-plum)] text-white rounded-xl font-serif text-lg shadow-lg flex items-center justify-center gap-2"
        >
